...
if __name__ == "__main__":
    ...
    config = OmegaConf.load(opt.cfg_path)  # TODO: Optionally download from same location as ckpt and chnage this logic
    ...
    log_file = 'test_clip_score/clip_score.txt'
    with open(log_file, 'a') as f:
        f.write(f"{opt.data_dir} {prompt}: {sim_img}, {sim_text}\n")