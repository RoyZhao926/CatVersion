            ...
            if any([isinstance(module, _class) for _class in search_class]):
                ...
                *path, name = fullname.split(".")
                ...
                if exclude_children_of and any(
                    ...
                    continue
                # Otherwise, yield it
                yield parent, name, module #parent=ancestor是U-net的模块，module是ancestor中的子模块。
...
def inject_trainable_lora(
    ...
    for _module, name, _child_module in _find_modules(
        ...
        # #  modules
        # modules.append(_module._modules[name].lora_down.weight)
        # modules.append(_module._modules[name].lora_down.weight)
        ...
        names.append(name) #k_proj v_proj q_proj out_proj?
